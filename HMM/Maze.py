...
import random
# Author: Brendan Shaw, 2023, adapted from COSC 76 Materials
...
if __name__ == "__main__":
    test_maze1 = Maze("HMM/maze1.maz")
    print(test_maze1)
    print(test_maze1.colors_map)

    # test_maze2 = Maze("maze2.maz")
    # print(test_maze2)
    # print(test_maze2.is_floor(0, 0))
    # print(test_maze2.has_robot(1, 0))
    # print(test_maze2.has_robot(2, 0))
    # print(test_maze2.is_floor(3, 0))
