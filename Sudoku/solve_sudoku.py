...
if __name__ == "__main__":
    ...
    threshold = 0.1  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.1.sol")
    threshold = 0.2  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.2.sol")
    threshold = 0.3  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.3.sol")
    threshold = 0.4  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.4.sol")
    threshold = 0.5  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.5.sol")
    threshold = 0.6  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.6.sol")
    threshold = 0.7  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.7.sol")
    threshold = 0.8  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.8.sol")
    threshold = 0.9  # Random threshold for accepting non-improving moves
    random.seed(random_seed)
    test_walksat(threshold, puzzle_dir + cnf_file, solutions_dir + cnf_file + "_walksat_0.9.sol")
